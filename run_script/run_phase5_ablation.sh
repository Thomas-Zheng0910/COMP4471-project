...
SAVE_EVERY=15
BATCH_SIZE="${5:-2}"
GPU_LIST_RAW="${6:-4,6,7,0}" # Should change to free GPU IDs on your system
BATCH_SIZE_FUSION="${7:-$BATCH_SIZE}"
USE_TMUX="${8:-false}" # Can be safely set to false
...
echo "  ├── v2_validation_error_lineplot.png (was 'testing_error')"
echo "  ├── v2_generalization_gap_lineplot.png"
echo "  └── v2_final_error_bar.png"
echo ""
echo "Next steps for P1 (multi-seed stats):"
echo "  1. Run additional seeds for each method with different --seed values"
echo "  2. Execute: python -m scripts.phase5_final_test --runs_json <latest>.json"
echo "  3. Execute: python -m scripts.phase5_stats_aggregation --metrics_dir runs/phase5_final_test"
echo ""
...
echo "Comparison figures: docs/figures/"
echo "  ├── v2_training_error_lineplot.png"
echo "  ├── v2_testing_error_lineplot.png" && echo "  ├── v2_validation_error_lineplot.png"
echo ""
