...
from utils.geometric import erode
...
class EdgeGuidedLocalSSI(nn.Module):
    def __init__(
        ...
        try:
            from model.ops.extract_patches import RandomPatchExtractor
            ...
            print(
                ...
                "you will experience large slowdown, "
                "please install it: ",
                "`cd ./model/ops/extract_patches && bash compile.sh`",
            )
